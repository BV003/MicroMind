...
def get_prompt_datas(args):
    """
    所有模型统一测试问题，用于评估生成效果。
    无论是 pretrain、SFT、RLHF、Reason 还是 LoRA，均使用相同题目。
    """
    prompt_datas = [
        "如果A比B高，B比C矮，谁最高？",
...
def main():
    ...
    # 2-moe (145M)：(hidden_size=640, num_hidden_layers=8, use_moe=True)
    # 2-Small (26M)：(hidden_size=512, num_hidden_layers=8)
    # 2 (104M)：(hidden_size=768, num_hidden_layers=16)
